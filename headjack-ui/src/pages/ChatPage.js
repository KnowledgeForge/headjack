        ...
        <div className="py-6 px-4 sm:px-6 lg:py-12 lg:px-8 h-full flex flex-col w-full">
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-gray-900 dark:text-gray-900">
                        <BasicMessage {message.utterance}
                      </p>
                      {message.reply != null && (
                        <div className="mt-2">
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex">
            <input
              ...
              className="flex-grow px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-200 dark:text-gray-900"
  ...
  <>
    ...
    >
      ...
      >
        ...
        <p className="text-gray-900 dark:text-gray-900">
          {message.isUser ? message.utterance : <Message message={message} />}
        </p>
      </div>
    </div>
  </>
